...
| `collateral_token`     | CanonicalAddr | Contract address of aLuna Token          |
| `overseer_contract`    | CanonicalAddr | Contract address of Overseer             |
| `market_contract`      | CanonicalAddr | Contract address of Market               |
| `reward_contract`      | CanonicalAddr | Contract address of aLuna Reward         |
...
| `basset_info`          | BAssetInfo    | aAsset token information                 |
...
| `collateral_token`     | String     | Contract address of aLuna Token          |
| `overseer_contract`    | String     | Contract address of Overseer             |
| `market_contract`      | String     | Contract address of Market               |
| `reward_contract`      | String     | Contract address of aLuna Reward         |
...
| Key        | Type   | Description                        |
| ---------- | ------ | ---------------------------------- |
| `name`     | String | Name of aAsset                     |
| `symbol`   | String | Symbol of aAsset                   |
| `decimals` | u8     | Number of decimals of aAsset token |
...
Withdraws accrued rewards from the aLuna Contract, swaps rewards to the appropriate stablecoin denomination. Can only be issued by `Overseer`.
...
Deposits collateral. Issued when a user sends aAsset tokens to the Custody contract.
...
| `overseer_contract`    | String     | Contract address of Overseer             |
| `market_contract`      | String     | Contract address of Market               |
| `reward_contract`      | String     | Contract address aLuna Reward            |
| `liquidation_contract` | String     | Contract address of Liquidation Contract |
| `stable_denom`         | String     | Native token denomination for stablecoin |
| `basset_info`          | BAssetInfo | aAsset token information                 |
...
| Key        | Type   | Description                        |
| ---------- | ------ | ---------------------------------- |
| `name`     | String | Name of aAsset token               |
| `symbol`   | String | Symbol of aAsset token             |
| `decimals` | u8     | Number of decimals of aAsset Token |
